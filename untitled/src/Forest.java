    ...
    void getLocation(){
        ...
        while (onLocition){
            ...
            if (obsPiece == 0){
                ...
                System.out.println("Karşınızda "+obsPiece+" Adet Vampir var!");
                System.out.println("Karakter sağlık : " + player.healthy);
                System.out.println("Karakter hasar : " + player.damage);
                System.out.println("Vampir sağlık : " + obstacle.obsHealty);
                System.out.println("Vampir hasar : " + obstacle.obsDamage);
    ...
    void war(){
        for(int i = 1; i<= obsPiece;obsPiece--){
            ...
            if (player.healthy <= 0){
                ...
                if ((obsPiece-1)==0){
                    System.out.println("Tüm canavarlar yok edildi ganimet olarak odun kazandınız...");
