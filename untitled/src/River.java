    ...
    void getLocation(){
        ...
        while (onLocition){
            ...
            if (obsPiece == 0){
                ...
                System.out.println("Karşınızda "+obsPiece+" Adet Ayı var!");
                System.out.println("Karakter sağlık : " + player.healthy);
                System.out.println("Karakter hasar : " + player.damage);
                System.out.println("Ayı sağlık : " + obstacle.obsHealty);
                System.out.println("Ayı hasar : " + obstacle.obsDamage);
    ...
    void war(){
        for(int i = 1; i<= obsPiece;obsPiece--){
            ...
            if (player.healthy <= 0){
                ...
                if ((obsPiece-1)==0){
                    System.out.println("Tüm canavarlar yok edildi ganimet olarak su kazandınız...");
